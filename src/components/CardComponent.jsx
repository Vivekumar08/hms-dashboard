  ...
  return (
    <>
      <div className="flex items-center gap-5 ">
        ...
        <div className="w-full text-justify h-full mb-4">
          {snapshotInfo ? (
            <>
              ...
              <textarea
                ...
                rows={rows ?? 7}
                cols={cols ?? 8}
                className="resize-none h-full overflow-clip text-justify border rounded-md p-2 w-full focus:outline-none focus:ring focus:border-blue-300"
                disabled
              />
            </>
          ) : details ? (
                ...
                <div className={`flex justify-center my-2 h-full relative`}>
                  <div className="flex  w-full gap-y-5 flex-col ">
                    <div className="flex w-full  gap-4">
                      <p className="flex justify-start font-bold w-[40%]">
                        Patient
                      </p>
                      <p
                        className={
